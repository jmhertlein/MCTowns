...
/**
 * A PermissionContext is a set of permission groups, and is usually defined in
 * a yaml file.
 *
 * A PermissionContext will ALWAYS have a "default" group. If one is not
 * specified in the yaml file, one will be created for you, will no inheritance,
 * type resident, and no authorized actions.
 *
 * Example yaml file:
 *
 * groups: #normal players can look at things default: type: resident inherits:
 * authorized: - KEY_EXCHANGE - TERMINATE_SESSION - GET_TOWN_VIEW -
 * GET_TOWN_LIST ...
 *
 * This will make a group named "default" of type "resident" which does not
 * inherit actions from any other group, and which is authorized for the four
 * actions listed under "authorized".
 *
 * @author joshua
 */
