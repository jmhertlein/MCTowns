...
public class BlockBank implements Externalizable {
    ...
    /**
     * Attempts to subtract quantity blocks of type corresponding to dataValue from the bank.
     * The withdrawl either completes successfully (EXACTLY 'quantity' blocks were withdrawn)
     * and true is returned, or NOTHING happens and false is returned.
