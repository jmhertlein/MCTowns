 ...
 * @author joshua
 */
public class YAMLManager implements TownManager {
    ...
    public boolean addPlot(String fullPlotName, World worldPlotIsIn, ProtectedRegion reg, Town parentTown, Territory parentTerritory) {
        ...
        try {
            ...
            Logger.getLogger(YAMLManager.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     */
    public static YAMLManager readYAML(String rootDirPath) throws FileNotFoundException, IOException, InvalidConfigurationException {
        File rootDir = new File(rootDirPath);
        FileConfiguration metaF, f;

        YAMLManager ret = new YAMLManager();
